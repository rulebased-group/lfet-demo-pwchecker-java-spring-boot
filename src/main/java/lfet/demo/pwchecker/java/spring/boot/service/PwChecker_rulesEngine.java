        ...
        while ( !exit )
        {
            ...
            if ( ruleGroup == 1 ) // Prüfschritt? 1 - Prüfen: Die Passwortlänge
            {
                if ( iFace._is(PwChecker_iFace.AnzahlZeichen.$LESS8 /* < 8 */ , model) )
                {
                    ...
                    // logging beforeRule
                    decisionTableLoggingFacade.traceBeforeRule("PwChecker","20230421.061715",1,7,model);
                    ...
                    decisionTableLoggingFacade.traceAfterRule("PwChecker","20230421.061715",1,7,model);
                ...
                else if ( iFace._is(PwChecker_iFace.AnzahlZeichen.$820 /* 8 - 20 */ , model) )
                {
                    ...
                    // logging beforeRule
                    decisionTableLoggingFacade.traceBeforeRule("PwChecker","20230421.061715",2,7,model);

                    ruleGroup = 2;
                    exit = false;

                    decisionTableLoggingFacade.traceAfterRule("PwChecker","20230421.061715",2,7,model);
                ...
                else // Anzahl Zeichen? > 20 - mehr als 20 Zeichen
                {
                    ...
                    // logging beforeRule
                    decisionTableLoggingFacade.traceBeforeRule("PwChecker","20230421.061715",3,7,model);
                    ...
                    decisionTableLoggingFacade.traceAfterRule("PwChecker","20230421.061715",3,7,model);
            ...
            else if ( ruleGroup == 2 ) // Prüfschritt? 2 - Prüfen: Die Anzahl verschiedener Kleinbuchstaben im Passwort
            {
                if ( iFace._is(PwChecker_iFace.AnzahlVerschiedeneKleinbuchstaben.$LESS2 /* < 2 */ , model) )
                {
                    ...
                    // logging beforeRule
                    decisionTableLoggingFacade.traceBeforeRule("PwChecker","20230421.061715",4,7,model);
                    ...
                    decisionTableLoggingFacade.traceAfterRule("PwChecker","20230421.061715",4,7,model);
                ...
                else // Anzahl verschiedene Kleinbuchstaben? >= 2 - 2 oder mehr
                {
                    ...
                    // logging beforeRule
                    decisionTableLoggingFacade.traceBeforeRule("PwChecker","20230421.061715",5,7,model);

                    ruleGroup = 3;
                    exit = false;

                    decisionTableLoggingFacade.traceAfterRule("PwChecker","20230421.061715",5,7,model);
            ...
            else // Prüfschritt? 3 - Prüfen: Die Anzahl verschiedener Grossbuchstaben im Passwort
            {
                if ( iFace._is(PwChecker_iFace.AnzahlVerschiedeneGrossbuchstaben.$LESS2 /* < 2 */ , model) )
                {
                    ...
                    // logging beforeRule
                    decisionTableLoggingFacade.traceBeforeRule("PwChecker","20230421.061715",6,7,model);

                    iFace._do(PwChecker_iFace.AnforderungNichtErfuellt.$GB2, model);

                    exit = true;

                    decisionTableLoggingFacade.traceAfterRule("PwChecker","20230421.061715",6,7,model);
                ...
                else // Anzahl verschiedene Grossbuchstaben? >= 2 - 2 oder mehr
                {
                    ...
                    // logging beforeRule
                    decisionTableLoggingFacade.traceBeforeRule("PwChecker","20230421.061715",7,7,model);

                    exit = true;

                    decisionTableLoggingFacade.traceAfterRule("PwChecker","20230421.061715",7,7,model);
